# LEGO-LOAM With Chinese Comments

Lego-LOAM 的详细中文注释版本，主要为个人学习用，欢迎讨论。

- 关于前端特征提取的逻辑可以参考 [A-LOAM 代码分析](https://xiaotaoguo.com/tags/a-loam/)
- 关于后端特征残差优化部分的逻辑可以参考 [LIO-SAM 代码逻辑梳理](https://xiaotaoguo.com/tags/lio-sam/)
...
-->
<p align='center'>
    <img src="reference/lego-loam/LeGO-LOAM/launch/demo.gif" alt="drawing" width="800"/>
</p>
...
<p align='center'>
    <img src="reference/lego-loam/LeGO-LOAM/launch/jackal-label.jpg" alt="drawing" width="400"/>
</p>

The package performs segmentation before feature extraction.

<p align='center'>
    <img src="reference/lego-loam/LeGO-LOAM/launch/seg-total.jpg" alt="drawing" width="400"/>
</p>

Lidar odometry performs two-step Levenberg Marquardt optimization to get 6D transformation.

<p align='center'>
    <img src="reference/lego-loam/LeGO-LOAM/launch/odometry.jpg" alt="drawing" width="400"/>
</p>
...
<p align='center'>
    <img src="reference/lego-loam/LeGO-LOAM/launch/dataset-demo.gif" alt="drawing" width="600"/>
</p>
<p align='center'>
    <img src="reference/lego-loam/LeGO-LOAM/launch/google-earth.png" alt="drawing" width="600"/>  
</p>
